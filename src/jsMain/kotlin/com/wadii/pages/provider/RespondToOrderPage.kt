...
import com.wadii.viewmodel.RespondToOrderEvent
import com.wadii.viewmodel.RespondToOrderScreenModel
...
@Composable
fun RespondToOrderPage(orderId: Long) {
            ...
            is UiState.Success -> {
                ...
                Div(attrs = { classes("bg-white", "rounded-2xl", "p-6", "shadow-sm") }) {
                    ...
                    Div(attrs = { classes("space-y-5") }) {
                        ...
                        Button(attrs = {
                            classes("w-full", "py-3", "bg-amber-500", "hover:bg-amber-600", "text-white", "font-semibold",
                                "rounded-xl", "disabled:opacity-60", "transition-colors", "flex", "items-center", "justify-center", "gap-2")
                            attr("type", "button")
