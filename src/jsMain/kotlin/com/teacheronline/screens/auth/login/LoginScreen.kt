...
import com.teacheronline.screens.auth.register.RegisterScreen
        ...
        Div(attrs = { classes("min-h-screen", "flex", "items-center", "justify-center", "p-4") }) {
            Div(attrs = { classes("w-full", "max-w-md") }) {
                Div(attrs = { classes("text-center", "mb-10") }) {
                    ...
                    P(attrs = { classes("text-body-subtle", "text-sm", "tracking-widest", "uppercase") }) { Text("Educational center management") }
                }
