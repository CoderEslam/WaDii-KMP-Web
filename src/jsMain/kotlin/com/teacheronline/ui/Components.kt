...
fun Toast() {
    ...
    val (bg, border, text, icon) = when (variant) {
        com.teacheronline.state.ToastVariant.Success -> arrayOf("bg-success-soft", "border-success-subtle", "text-fg-success-strong", "✓")
        com.teacheronline.state.ToastVariant.Warning -> arrayOf("bg-warning-soft", "border-warning-subtle", "text-fg-warning", "⚠")
        com.teacheronline.state.ToastVariant.Error   -> arrayOf("bg-danger-soft", "border-danger-subtle", "text-fg-danger-strong", "✕")
    }
