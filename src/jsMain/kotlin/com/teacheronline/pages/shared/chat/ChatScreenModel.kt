...
import com.teacheronline.domain.model.Paginator
    ...
    private fun chatList() = screenModelScope.launch {
        messageUseCase.chatList { r ->
            r.handelState(
                ...
                onSuccess = { data ->
                    updateState { it.copy(contacts = data.data ?: emptyList(), isLoading = false) }
                },
    ...
    private fun buildPaginator(contactId: Long) = Paginator<Int, PageMessages>(
        ...
        onRequest = { page ->
            ...
            messageUseCase.conversation(contactId, page) { r ->
                when (r) {
                    is RequestState.Success -> result = RequestState.Success(r.data.data ?: PageMessages())
